...
async function createProduct(reqData) {
  ...
  const product = new Product({
    ...
    topLevelCategory: reqData.topLavelCategory,
    secondLevelCategory: reqData.secondLavelCategory,
    thirdLevelCategory: reqData.thirdLavelCategory,
  });
...
async function getAllProducts(reqQuery) {
  ...
  // Handle minimum discount filtering
  if (minDiscount) {
